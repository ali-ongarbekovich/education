...
<div class="col-lg-8 col-md-8">
   ...
   <div class="post beforepagination">
      ...
      <div class="postinfobot">
         <div class="likeblock pull-left">
            <a href="02_topic.html#" class="up"><i class="fa fa-thumbs-o-up"></i>25</a>
            <a href="02_topic.html#" class="down"><i class="fa fa-thumbs-o-down"></i>3</a>
         </div>
         <div class="prev pull-left">
            <a href="02_topic.html#"><i class="fa fa-reply"></i></a>
         </div>
         <div class="posted pull-left"><i class="fa fa-clock-o"></i> Posted on : 20 Nov @ 9:30am</div>
         <div class="next pull-right">
            <a href="02_topic.html#"><i class="fa fa-share"></i></a>
            <a href="02_topic.html#"><i class="fa fa-flag"></i></a>
         </div>
         <div class="clearfix"></div>
      </div>
   </div>
   ...
   <div class="post">
      ...
      <div class="postinfobot">
         <div class="likeblock pull-left">
            <a href="02_topic.html#" class="up"><i class="fa fa-thumbs-o-up"></i>10</a>
            <a href="02_topic.html#" class="down"><i class="fa fa-thumbs-o-down"></i>1</a>
         </div>
         <div class="prev pull-left">
            <a href="02_topic.html#"><i class="fa fa-reply"></i></a>
         </div>
   ...
   <div class="post">
      ...
      <div class="postinfobot">
         <div class="likeblock pull-left">
            <a href="02_topic.html#" class="up"><i class="fa fa-thumbs-o-up"></i>55</a>
            <a href="02_topic.html#" class="down"><i class="fa fa-thumbs-o-down"></i>12</a>
         </div>
         <div class="prev pull-left">
            <a href="02_topic.html#"><i class="fa fa-reply"></i></a>
         </div>
      ...
      <form action="#" class="form" method="post">
         ...
         <div class="postinfobot">
            ...
            <div class="pull-right postreply">
               <div class="pull-left smile"><a href="02_topic.html#"><i class="fa fa-smile-o"></i></a></div>
